				...
				@if($film != null)
					@foreach($film as $itemfilm)
						<tr>
							...
							@foreach($movieNoEpisodes as $keyArrayCountEpisodes => $itemArrayCountEpisodes)
									@if($itemfilm->movie_id == $keyArrayCountEpisodes)
										<td align="center">{{$itemArrayCountEpisodes}}</td>
										@break
									@endif
							@endforeach
	
	
							@foreach($endMC as $keyEMC => $valueEMC)
								@if($itemfilm->movie_id == $keyEMC)
									<td align="center" class="done">{!! $valueEMC !!}</td>
								@endif
							@endforeach
